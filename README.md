Веб-платформа для прогнозирования временных рядов с использованием нескольких алгоритмов машинного обучения. Цифровой продукт носит ознакомительный характер. Не коммерция
